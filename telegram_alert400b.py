...
TELEGRAM_BOT_TOKEN = os.getenv("TELEGRAM_BOT_TOKEN_400b")
CHAT_IDS_FILE = "telegram_chat_ids_400b.json"
CONFIG_FILE = "config400b.json"
...
def send_trade_alert(symbol: str, action: str, price: float, date: str):
    if time.time() - START_TIME < BREAKOUT_DELAY:
        return
